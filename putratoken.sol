...
/* 
  forestbit.io CEOx Initial Token Offering #ITO77002
  Creation Date : 01 May 2019
  Token Code    : PTR
  Token Name    : Putra Token
  Max Supply    : 30B;3000 Million;30,000,000,000 PTR 
...
contract PUTRATOKEN is TheLiquidToken {
  string public constant name = "PUTRA TOKEN";
  string public constant symbol = "PTR";
  uint public constant decimals = 8;
  uint256 public initialSupply;
    
  function PUTRATOKEN () { 
     totalSupply = 30000000000 * 10 ** decimals;
